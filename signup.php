...
<div class=" custom_regiser inner_content cus_zindex">
	<div class="col-md-8 col-sm-8 col-xs-12">
		<h2>CheckAim Registration</h2>
		<p>Use our AI &amp; Machine Learning System to protect your sales pipeline!</p>
		...
		<?php
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<textarea name="termsCondn" class="form-control"  rows="5">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<div class="form-check">
					    <input type="checkbox" class="form-check-input" required name="terms" value="1">
					    <label class="form-check-label" >Click here to indicate that you have read and agree to the User Agreement and Privacy Policy.</label>
					</div>
				</div>
			</div>
			<div class="form-group">
					<div class="col-md-8 col-md-offset-4" style="padding: 20px 0px 20px 20px;">
	...
	<div class="col-md-4 col-sm-4 col-xs-12 signup_sidebar">
		<h2>WHY JOIN?</h2> 
		<ul>		
			<li>Protect Against Potential Fraud</li>
			<li>Get Alerted On Risk</li>
			<li>Cross Device Tracking</li>
			<li>Know Your Sales History</li>
			<li>Worldwide Reach</li>
			<li>Monitor Your Sales Data</li>
			<li>Identify Previous Visits</li>
			<li>Easy To Use Platform</li>
			<li>Real time Reporting / Alerts</li>
			<li>Dont be part of $3.7 Trillion A Year Fraud</li>
		</ul> 
	</div>
	<div class="clearfix"></div>
</div>	
