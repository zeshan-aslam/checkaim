...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        Chartist.Pie('#chartEmail', {
            labels: [pclick+'%', plead+'%', psale+'%'],
            series: [pclick, plead, psale]
        });
    ...
    showNotification: function(from, align) {
		if(is_show_welcome == '1'){
        color = Math.floor((Math.random() * 4) + 1);

        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome to <b>CheckAIM Dashboard</b>."
	 ...
	 showcustomNotification: function(from, align) {
        color = Math.floor((Math.random() * 4) + 1);
