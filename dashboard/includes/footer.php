			...
			<div class="container">
				<nav>
					...
					<p class="copyright text-center">
						...
						<a href="https://www.searlco.com" target="_blank">Searlco </a>,  AI &amp; Machine Learning With Power!.
					</p>
				</nav>
			</div>
		</footer>
	...
	<div class="dropdown show-dropdown">
		...
		<ul class="dropdown-menu">
			...
			<li class="button-container">
				<a target="_blank" href="#" id="twitter" class="btn btn-social btn-twitter btn-round"><i class="fa fa-twitter"></i></a>
				<a target="_blank" href="#" id="facebook" class="btn btn-social btn-facebook btn-round"><i class="fa fa-facebook-square"></i></a>
			</li>
		</ul>
	</div>
</div>
...
<script src="<?php echo LEADURL; ?>public/assets/js/plugins/jquery.form.min.js" type="text/javascript"></script>
...
<script src="<?php echo LEADURL; ?>public/assets/lib/summernote/summernote.min.js"></script>
<script src="<?php echo LEADURL; ?>public/assets/js/jscolor.js"></script>
<!-- Light Dashboard DEMO methods, don't include it in your project! -->
<script src="<?php echo LEADURL; ?>js/demo.js"></script>

<?php 
	if(isset($_GET['Act']) && ($_GET['Act'] == 'home' || $_GET['Act'] == 'transactions'|| $_GET['Act'] == 'statistics'))
	{ 
?>
...
<script src="<?php echo LEADURL; ?>js/dashboard.js?v=1.0"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		<?php 
			if(isset($_GET['Act']) && $_GET['Act'] == 'homeold')
			{ 
		?>
        		demo.initDashboardPageCharts();
		<?php 
			}
			else if(isset($_GET['Act']) && $_GET['Act'] == 'home') 
			{
		?>
				Dashboard.DailyChartData = dailyChartData;
				Dashboard.MonthlyChartData = monthlyChartData;
				Dashboard.YearlyChartData = yearlyChartData;
...
<div id="divPageLoader" class="page-loader" style="display:none; ">
